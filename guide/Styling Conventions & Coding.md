...
This idea is perhaps a little harder to grasp but it is the idea that only content that has a *meaning* should be in the html files of your projects. As a mentor of mine said when I put an image directly in my html file.
